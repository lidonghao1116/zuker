class Users::HousesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @house.save
        format.html {
          redirect_to basic_user_house_path(@user, @house)
  ...
  def update
    ...
    respond_to do |format|
      if @house.update(house_params)
        ...
        format.js { render 'users/houses/profiles/basic' }
      else
