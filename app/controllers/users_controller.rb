class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :password, :password_confirmation, :phone_number, :email, :start_school_year, :verified)
    end

    def exist_user_params
      params.require(:user).permit(:name, :phone_number, :email, :start_school_year, :verified)
    end
end
